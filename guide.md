...
* **Свобода.** Вы выбираете как пользоваться этой платформой, и как Ваши данные будут обрабатываться.
  ...
  * Автоматический сбор данных минимизирован: нет синхронизации телефонной книги[^3], без "вы человек?" проверек после регистрации, телефонные номера необязательны, даже email адреса необязательны (в зависимости от домашнего сервера)!
